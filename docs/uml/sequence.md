...
На ней показаны три ключевых потока: первичная загрузка кодов валют, синхронизация актуальных курсов и запрос истории для графика (с учетом кэша и условного backfill).  
